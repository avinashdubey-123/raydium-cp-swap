...
#[cfg(feature = "devnet")]
declare_id!("J1h1sProk7RbLzyvsSM8YE1hZz3ALMwQu6wzqeRSRGbD");
...
pub mod admin {
    ...
    #[cfg(feature = "devnet")]
    pub const ID: Pubkey = pubkey!("wE2EtwuovRxvXZoThsXhRTuCrFdAA1jTbLnJp9nfezL");
    #[cfg(not(feature = "devnet"))]
...
pub mod create_pool_fee_receiver {
    use super::{pubkey, Pubkey};
    #[cfg(feature = "devnet")]
    pub const ID: Pubkey = pubkey!("63EqUEuqiLw9ZvJJsFECg5fN7bM9hBifUEYJFGhJtuCa");
    #[cfg(not(feature = "devnet"))]
